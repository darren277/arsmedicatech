      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">You must be logged in to manage organizations.</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">You do not have permission to manage organizations.</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-900">{org.description || 'No description provided'}</p>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="text-center mb-8">
            ...
            <h2 className="mt-4 text-2xl font-bold text-gray-900">Create Your Organization</h2>
            <p className="mt-2 text-gray-600">Set up your organization to get started with the platform.</p>
          </div>
