...
CREATE TABLE `formfollowup` (
  ...
  `commentsOnEducation` text default NULL,
  `typeOfIncome` text default NULL,
  `historyOfJail` text default NULL,
  `dateEnteredSeaton` varchar(24) default NULL,
  `commentsOnStreetDrugs` text default NULL,
  ...
  `whySponsorshipBreakdown` text default NULL,
  ...
  `clientLastAddress` text default NULL,
  `mainSourceOfIncome` text default NULL,
  `cbox_assistWithNone` char(1) default NULL,
  `dateExitedSeaton` varchar(24) default NULL,
  `cbox_haveOHIP` char(1) default NULL,
  `housingInterested` text default NULL,
  `assistWithOther` text default NULL,
  `needHelpWithImmigration` text default NULL,
  ...
  `assistProvided2` text default NULL,
  ...
  `clientFirstName` text default NULL,
  ...
  `whereOweRent` text default NULL,
  ...
  `needAssistInLegal` text default NULL,
  ...
  `livedWithWhom` text default NULL,
  `assistProvided3` text default NULL,
  `cbox_haveManic` char(1) default NULL,
  `contact1Name` text default NULL,
  ...
  `assistProvided4` text default NULL,
  `doctor1NameAddr` text default NULL,
  `contact3Name` text default NULL,
  `haveOther` text default NULL,
  `cbox_storeMedication` char(1) default NULL,
  `agency4Name` text default NULL,
...
CREATE TABLE `formreceptionassessment` (
  ...
  `reasonToSeaton` text default NULL,
  `datesAtSeaton` text default NULL,
  ...
  `otherIdentification` text default NULL,
  ...
  `healthIssueDetails` text default NULL,
  ...
  `mobilityImpair` text default NULL,
  `radio_otherHealthConcern` varchar(36) default NULL,
  `otherHealthConerns` text default NULL,
  `radio_takeMedication` varchar(36) default NULL,
  `namesOfMedication` text default NULL,
  `radio_helpObtainMedication` varchar(36) default NULL,
  `helpObtainMedication` text default NULL,
  `radio_allergicToMedication` varchar(36) default NULL,
  `allergicToMedicationName` text default NULL,
  `reactionToMedication` text default NULL,
  `radio_mentalHealthConcerns` varchar(36) default NULL,
  `mentalHealthConcerns` text default NULL,
  ...
  `treatOtherReasons` text default NULL,
  ...
  `contactRelationship` text default NULL,
  ...
  `seatonNotToured` text default NULL,
  `radio_pamphletIssued` varchar(36) default NULL,
  `pamphletNotIssued` text default NULL,
...
CREATE TABLE `formDischargeSummary` (
  ...
  `changeMedications` text default NULL,
  `referralProgram1` text default NULL,
  `referralMade1` text default NULL,
  `referralOutcome1` text default NULL,
  `referralProgram2` text default NULL,
  `referralMade2` text default NULL,
  `referralOutcome2` text default NULL,
  `referralProgram3` text default NULL,
  `referralMade3` text default NULL,
  `referralOutcome3` text default NULL,
  `referralProgram4` text default NULL,
  `referralMade4` text default NULL,
  `referralOutcome4` text default NULL,
  `referralProgram5` text default NULL,
  `referralMade5` text default NULL,
  `referralOutcome5` text default NULL,
