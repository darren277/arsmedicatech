 ...
 */
export async function checkElementVisible(page: Page, selector: string, timeout = 5000) {
 ...
 */
export async function safeFill(page: Page, selectorOrLocator: string | Locator, value: string) {
  let element: Locator;
